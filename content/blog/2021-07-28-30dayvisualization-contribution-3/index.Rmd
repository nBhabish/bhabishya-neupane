...
termination_reason %>% 
    ...
    theme(plot.background = element_blank(),
          ...
          plot.caption = element_text(size = "10", family = "Rock Salt"),
          plot.title = element_text(size = "25", family = "Rock Salt", hjust = 0.5),
          plot.title.position = "plot",
          plot.subtitle = element_text(hjust = 0.5, family = "Rock Salt", size = 15),
