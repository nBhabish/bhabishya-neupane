...
- I have used `scale_y_log10` on the y-axis, so here's what `scale_y_log10` does:
`scale_y_log10` makes the counts, converts them to logs, stacks those logs, and then displays the scale in the anti-log form. 
