---
title: '#TidyTuesday: Art Collections'
author: Bhabishya Neupane
date: '2022-02-24'
slug: []
excerpt: "I will be using `infer` package to find the average dimension of arts around the world"
categories:
...
```toml
The data comes from Tate Art Museum. 
```
