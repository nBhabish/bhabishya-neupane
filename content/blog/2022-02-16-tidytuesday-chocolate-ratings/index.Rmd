...
chocolate %>% 
  ...
  labs(x = "", 
       ...
       subtitle = "This Review was conducted by The Manhattan Chocolate Society",
       caption = "Data Source: The Manhattan Chocolate Society")+
  theme(text = element_text(family = "BenchNine"),
...
Most of the chocolate manufacturing companies reviewed around the world have cocoa usage of 70% to 75% in their products. 
